...
from libcity.pipeline import transfer
...
if __name__ == '__main__':
    ...
    other_args = {key: val for key, val in dict_args.items() if key not in [
        ...
        val is not None}
    transfer(task=args.task, model_name=args.model, source_dataset_name=args.source_dataset,target_dataset_name=args.target_dataset,
