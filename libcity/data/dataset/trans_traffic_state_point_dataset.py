...
from libcity.data.dataset import TransTrafficStateDataset


class TransTrafficStatePointDataset(TransTrafficStateDataset):
    ...
    def _load_dyna(self, filename,source):
        ...
        """
        return super()._load_dyna_3d(filename,source)
